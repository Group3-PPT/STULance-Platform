...
import { Bell, LogOut, LayoutDashboard, Settings, History, PlusSquare, Building2, Search } from 'lucide-react';
        ...
        <Navbar.Collapse id="business-navbar">
          ...
          <Nav className="align-items-center gap-3">
            ...
            <NavDropdown 
              title={
                <div className="d-inline-flex align-items-center gap-2">
                  <Image src="https://ui-avatars.com/api/?name=Business&background=E91E63&color=fff" roundedCircle width="34" height="34" className="border border-danger"/>
                  <div className="text-start d-none d-xl-block" style={{lineHeight: '1.2'}}>
                    <span className="small text-white d-block fw-bold">Doanh nghiệp</span>
                    <span className="x-small text-muted">Jx7ze2Kd</span>
                  </div>
                </div>
              } 
            ...
            >
              ...
              <NavDropdown.Item as={Link} to="/manage-jobs"><LayoutDashboard size={18} className="me-3 text-primary" /> Quản lý bài đăng</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/businesses/business-profile-settings"><Settings size={18} className="me-3 text-primary" /> Cài đặt hồ sơ</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/payment"><History size={18} className="me-3 text-primary" /> Ví doanh nghiệp</NavDropdown.Item>
              <NavDropdown.Divider />
