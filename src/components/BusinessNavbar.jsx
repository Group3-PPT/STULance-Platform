...
import { Bell, LogOut, LayoutDashboard, Settings, History, PlusSquare, CheckCheck, Wallet, Heart, Briefcase } from 'lucide-react';
        ...
        <Navbar.Collapse id="business-navbar">
          ...
          <Nav className="d-flex align-items-center gap-3 nav-actions-mobile">
            ...
            >
              ...
              <NavDropdown.Item as={Link} to="/businesses/business-profile/me">
                <Briefcase size={18} className="me-3 text-primary" /> Hồ sơ doanh nghiệp
              </NavDropdown.Item>
